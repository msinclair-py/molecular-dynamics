source loadtraj.tcl
set helix_a "protein and resid 452 to 474"
set helix_b "protein and resid 424 to 439"
set inter "protein and resid 440 to 451"
...
set up [atomselect top "protein and resid 474"]
set down [atomselect top "protein and resid 452"]
set all [atomselect top "all"]
#set outfile [open "ahelix_water_density.txt" w]
...
#puts "aligning structure....."
#align_sel $helix_b
#set top [atomselect top "protein and resid 432 to 436"]
#set bot [atomselect top "protein and resid 427 to 431"]
#set up [atomselect top "protein and resid 439"]
#set down [atomselect top "protein and resid 424"]
#set outfile [open "bhelix_water_density.txt" w]
...
#puts "aligning structure....."
#align_sel $inter
#set top [atomselect top "protein and resid 457 to 461"]
#set bot [atomselect top "protein and resid 432 to 436"]
#set up [atomselect top "protein and resid 452"]
#set down [atomselect top "protein and resid 439"]
#set outfile [open "interhelix_water_density.txt" w]
